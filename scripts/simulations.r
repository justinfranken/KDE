...
coverage_prob_grid_2a <- expand.grid(data_model = data_model,
                                    x_point = x_point,
                                    n = n,
                                    bandwidth_model = c("cv","plug_in_sj","silverman"),
                                    eta = 1, 
...
# grid for robust bias correction (and undersmoothing bias estimate)
coverage_prob_grid_2b <- expand.grid(data_model = data_model,
                                    x_point = x_point,
                                    n = n,
                                    bandwidth_model = c("silverman"),
                                    eta = c(0.6,0.7,0.8,0.9), 
                                    lambda = 1,
                                    conf_int_model = c("rbc"),
                                    kernel = kernel)
...
coverage_prob_grid <- rbind(coverage_prob_grid_1,
                            coverage_prob_grid_2a,
                            coverage_prob_grid_2b,
